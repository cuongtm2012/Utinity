...
public class GTMDP16 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		 ...
		 try {
	            String input = "C:\\Users\\e1067720\\Desktop\\HK_project\\4. Example\\text\\GTMDP16_002.TXT";
	            ...
	            while ((line = br.readLine()) != null) {
		                if(line.length() > 9){
		                	...
		                	try{
		                		cardno = Integer.valueOf(octopus);
	...
	public static void analysis(String line){
		...
		try{
			...
			insertDB(octopus, accountNo, refundIndicator, amount, lastTranTime, cardStatus, respCodeDesc);
			
		} catch(Exception ex){
			System.out.println("Error CardNo : "+octopus+" - "+accountNo+ refundIndicator + amount + lastTranTime+ cardStatus + respCodeDesc);
			System.out.println(ex.getMessage());
		}
		
	}

	public static void insertDB(String octopus, String accountNo, String refundIndicator, String amount, 
			String lastTranTime, String cardStatus, String respCodeDesc){
		...
		String sqlInsert = "Insert into GTMDP16(OCTOPUS,ACCOUNTNO,REFERENCEINDICATOR,AMOUNT,LASTTRANTIME,CARDSTATUS,RESPCODEDESC) "
				+ "values ('"+octopus+"','"+accountNo+"','"+refundIndicator+"','"+amount+"','"+lastTranTime+"','"+cardStatus+"','"+respCodeDesc+"')";
		try{
