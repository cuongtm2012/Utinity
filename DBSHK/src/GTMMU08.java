...
public class GTMMU08 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub	
		 try {
	            String input = "C:\\Users\\e1067720\\Desktop\\HK_project\\4. Example\\text\\GTMMU08_406.TXT";
	...
	public static void analysis(String line){
		...
		try{
			...
			dateIssued = line.substring(2, 12).trim();
			dateExp = line.substring(2, 12).trim();
			holderName = line.substring(2, 12).trim();
			cardStt = line.substring(2, 12).trim();
			sttName = line.substring(2, 12).trim();

			insertDB(cardNo, dateIssued, dateExp, holderName, cardStt, sttName);
