...
public class GTMDPO52 {
	...
	public static String insertDB(String debtorAccountNo, String applicantName,
		...
		try {
			sqlInsert = "Insert into GTMDPO52(DEBTORACCNO,APPLICANTNAME,DEBTORREF,OCTOPUS, TRANSEQ, TRANDATE,TRANAMOUNT,RESPCODEDESC) "
					+ "values ('"
					+ debtorAccountNo
					+ "','"
					+ applicantName
